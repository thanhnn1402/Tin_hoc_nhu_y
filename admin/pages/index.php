                            ...
                            <div class="col-lg-8 mb-4 order-0">
                                <div class="card">
                                    <div class="d-flex align-items-end row">
                                        <div class="col-sm-7">
                                            <div class="card-body">
                                                <h5 class="card-title text-primary">Xin chúc mừng <?= $adminlogged['fullname'] ?>! 🎉</h5>
                                                <p class="mb-4">
                                                    Doanh thu hôm nay đã tăng <span class="fw-bold">72%</span> so với ngày hôm qua. Xem thông tin của bạn ngay bây giờ
                                                </p>
                                ...
                                <div class="card">
                                    <div class="row row-bordered g-0">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="text-center fw-semibold pt-3 mb-2">62% Tăng trưởng</div>
                                                ...
                                                <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                                                    <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                                                        <div class="card-title">
                                                            <h5 class="text-nowrap mb-2">Doanh thu</h5>
