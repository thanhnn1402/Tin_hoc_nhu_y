...
if (!empty($adminlogged)) {
    $sql = "SELECT ma_don_hang, khach_hang.ho_ten, ngay_lap, trang_thai, thanh_tien
          FROM don_hang, khach_hang
          WHERE don_hang.id_khach_hang = khach_hang.id";
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Đơn đặt hàng /</span> Danh sách đơn đặt hàng</h4>
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <?php foreach ($orders as $item) { ?>
                                            <tr>
                                                ...
                                                <td><?= $item['ho_ten'] ?></td>
                                                <td><?= $item['ngay_lap'] ?></td>
                                                <td><?= convert_state($item['trang_thai']) ?></td>
                                                <td><?= currency_format($item['thanh_tien']) ?></td>
                                                <td>
                                                    <a href="./order-edit.php?madonhang=<?= $item['ma_don_hang'] ?>" class="btn btn-sm btn-outline-info">
