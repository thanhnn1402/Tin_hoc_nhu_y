...
if (!empty($adminlogged)) {
    ...
    if (!empty($id)) {
        ...
        $stmt_get_product = $conn->prepare("SELECT * FROM san_pham WHERE id = ?");
        ...
        //
        if (isset($_POST['edit-product-submit']) && $_POST['edit-product-submit'] == 'submit') {
            ...
            if (empty($hinh_anh_chi_tiet)) {
                $hinh_anh_chi_tiet = $product['hinh_anh'];
            } else if (!empty($hinh_anh_chi_tiet) && count(explode('||', $hinh_anh_chi_tiet)) < 4) {

                $array_img = explode('||', $hinh_anh_chi_tiet);
            ...
            if (empty($error)) {
                ...
                $stmt_insert_product = $conn->prepare("UPDATE `san_pham` SET `ten_sp`= ? ,`don_gia_nhap`= ? ,`don_gia_ban`= ? , `phan_tram_khuyen_mai`= ? , `don_gia_khuyen_mai`= ?, `so_luong_kho`= ? ,`mo_ta`= ? , `hinh_anh_dai_dien` = ? ,`hinh_anh`= ? ,`ngay_nhap`= ? ,`id_loai_hang`= ? ,`updated_at`= ? WHERE id = ?");
                $stmt_insert_product->bind_param("sssssssssssss", $tensanpham, $dongianhap, $dongiaban, $phantramkhuyenmai, $dongiakhuyenmai, $soluong, $motasanpham, $hinhanh, $hinh_anh_chi_tiet, $ngaynhap, $id_loai, $date_current, $id);
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Sản phẩm /</span> Chỉnh sửa sản phẩm
                        </h4>
                            ...
                            <div class="row bg-white">
                                    ...
                                    <div class="card mb-4 shadow-none">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="tensanpham" name="tensanpham" value="<?php echo isset($product['ten_sp']) ? $product['ten_sp'] : ''; ?>" />
                                    ...
                                    <div class="card mb-4 shadow-none">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <input type="number" class="form-control" id="soluong" name="soluong" min="1" value="<?php echo isset($product['so_luong_kho']) ? $product['so_luong_kho'] : ''; ?>" />
                                                <span id="defaultFormControlHelp" class="form-text text-danger">
                                    ...
                                    <div class="card mb-4 shadow-none">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <input type="number" class="form-control" id="dongianhap" name="dongianhap" min="1" value="<?php echo isset($product['don_gia_nhap']) ? $product['don_gia_nhap'] : ''; ?>" />
                                                <span id="defaultFormControlHelp" class="form-text text-danger">
                                    ...
                                    <div class="card mb-4 shadow-none">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <input type="number" class="form-control" id="dongiaban" name="dongiaban" min="1" value="<?php echo isset($product['don_gia_ban']) ? $product['don_gia_ban'] : ''; ?>" />
                                                <span id="defaultFormControlHelp" class="form-text text-danger">
                                    ...
                                    <div class="card mb-4 shadow-none">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <input type="number" class="form-control" id="phantramkhuyenmai" name="phantramkhuyenmai" min="0" max="100" value="<?php echo isset($product['phan_tram_khuyen_mai']) ? $product['phan_tram_khuyen_mai'] : ''; ?>" />
                                                <span id="defaultFormControlHelp" class="form-text text-danger">
                                    ...
                                    <div class="card mb-4 shadow-none">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <input type="number" class="form-control" id="dongiakhuyenmai" name="dongiakhuyenmai" min="1" value="<?php echo isset($product['don_gia_khuyen_mai']) ? $product['don_gia_khuyen_mai'] : ''; ?>" readonly disabled />
                                                <span id="defaultFormControlHelp" class="form-text text-danger">
                                                    <?php echo isset($error['dongiakhuyenmai']) ? $error['dongiakhuyenmai'] : ''; ?>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card mb-4 shadow-none">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <input type="date" class="form-control" id="ngaynhap" name="ngaynhap" value="<?php echo isset($product['ngay_nhap']) ? $product['ngay_nhap'] : ''; ?>" />
                                                <span id="defaultFormControlHelp" class="form-text text-danger">
                                ...
                                <div class="col-md-6">
                                    <div class="card mb-4 shadow-none">
                                        <div class="card-body">
                                            <div>
                                                <label for="id_loai" class="form-label">ID Loại sản phẩm</label>
                                                <select class="form-select" id="id_loai" name="id_loai" aria-label="Default select example">
                                                    <?php foreach ($loaisanpham as $item) { ?>
                                                        <option value="<?= $item['id'] ?>" <?php if ($item['id'] == $product['id_loai_hang']) echo 'selected'; ?>>
                                    ...
                                    <div class="card mb-4 shadow-none">
                                        <div class="card-body">
                                            ...
                                            <div class="grid-img grid-img-1 d-flex flex-wrap align-items-start mt-4">
                                                <img src="../../../storage/uploads/img/<?= $product['hinh_anh_dai_dien'] ?>" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="card mb-4 shadow-none">
                                        <div class="card-body">
                                            <div>
                                                <label for="hinhanh_chitiet" class="form-label">Hình ảnh sản phẩm</label>
                                    ...
                                    <div class="card mb-4 shadow-none">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <input name="motasanpham" type="hidden" id="motasanpham" value="">
                                ...
                                <div class="col-md-12 text-end p-4">
                                    <input type="hidden" name="edit-product-submit" value="submit">
