...
<body>
                    ...
                    <li class="menu-item active open">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item active">
                                <a href="./banner-list.php" class="menu-link">
                                    <div>Danh sách banner</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="./banner-add.php" class="menu-link">
                                    <div>Thêm banner</div>
                                </a>
                            </li>
                        </ul>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Banner /</span> Danh sách banner</h4>
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <?php foreach ($banners as $item) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="../../../storage/uploads/img/<?= $item['hinh_anh'] ?>" alt="<?= $item['alt'] ?>" style="width: 100px">
                                                </td>
                                                <td>
                                                    <?= $item['alt'] ?>
                                                </td>
                                                ...
                                                <td>
                                                    <a href="./banner-edit.php?id=<?= $item['id'] ?>" class="btn btn-sm btn-outline-info">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header border-bottom pb-3">
            <h5 class="modal-title" id="modal-title">Xóa banner quảng cáo</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <div class="row">
              <div class="col-md-12">
                <h5>Bạn có chắc xóa banner này, hành động này sẽ không thể khôi phục!</h5>
              </div>
            </div>
          </div>
    ...
    <script>
      ...
      modal.addEventListener('show.bs.modal', event => {
        ...
        const href = `./banner-delete.php?id=${button.getAttribute('data-id')}`;
