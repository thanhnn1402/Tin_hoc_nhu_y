...
<body>
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <?php foreach ($categories as $item) { ?>
                                            <tr>
                                                ...
                                                <td><span class="badge bg-label-primary me-1"><?= $item['duong_dan'] ?></span></td>
                                                <td>
                                                    <a href="./category-edit.php?id=<?= $item['id'] ?>" class="btn btn-sm btn-outline-info">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header border-bottom pb-3">
                    <h5 class="modal-title" id="modal-title">Xóa danh mục</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <h5>Bạn có chắc xóa danh mục này, hành động này sẽ không thể khôi phục!</h5>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        modal.addEventListener('show.bs.modal', event => {
            ...
            const href = `./category-delete.php?id=${button.getAttribute('data-id')}`;
