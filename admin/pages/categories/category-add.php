...
if (!empty($adminlogged)) {
    ...
    if (isset($_POST['category-add-submit']) && $_POST['category-add-submit'] == 'submit') {
        ...
        if (empty($error)) {
            $stmt = $conn->prepare("INSERT INTO `danh_muc`(`ten_danh_muc`, `duong_dan`) VALUES (?, ?)");
            $stmt->bind_param("ss", $tendanhmuc, $duongdan);
    ...
    <div class="layout-wrapper layout-content-navbar">
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Danh mục /</span> Thêm danh mục
                        </h4>
                        ...
                        <form id="form-product-add" action="" method="POST">
                            <div class="row bg-white">
                                    ...
                                    <div class="card mb-4 shadow-none">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="tendanhmuc" name="tendanhmuc" aria-describedby="defaultFormControlHelp" />
                                    ...
                                    <div class="card mb-4 shadow-none">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="duongdan" name="duongdan" min="1" aria-describedby="defaultFormControlHelp" />
                                                <span id="defaultFormControlHelp" class="form-text text-danger">
                                                    <?php echo isset($error['message']) ? $error['message'] : ''; ?>
                                                </span>
                                            </div>
                                ...
                                <div class="col-md-12 text-end p-4">
                                    <button type="submit" name="category-add-submit" value="submit" class="btn btn-primary me-3">Xác nhận</button>
                                </div>
        ...
        <script>
            ...
            form.onsubmit = function() {
                ...
                alert(description.value.length)
                return false;
            }
        </script>
</body>
